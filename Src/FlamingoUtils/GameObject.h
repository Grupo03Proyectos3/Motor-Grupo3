 ...
 * De momento solo almacena los datos b�sicos propios de un Quaternion similar al de Unity y actualiza el Ogre::Vector3 que contiene si se cambia su valor.
 */
 ...
 * Servir� de identificdor a la vez que almacena los valores del objeto en el mundo (posici�n, roataci�n y escala).
