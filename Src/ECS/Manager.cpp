...
//}
//
//ecs::GameObject* ecs::Manager::addGameObject(ecs::groupId t_gId)
//{
...
//}
//
//void ecs::Manager::setAlive(GameObject* t_e, bool t_alive)
//{
//    t_e->m_alive = t_alive;
//}
//
//bool ecs::Manager::isAlive(GameObject* t_e)
//{
//    return t_e->m_alive;
//}
//
//ecs::groupId_type ecs::Manager::groupId(GameObject* t_e)
//{
//    return t_e->m_gId;
//}
//
//void ecs::Manager::setHandler(handlerId_type t_hId, GameObject* t_e)
//{
//    assert(t_hId < maxHandlerId);
//    m_handlers[t_hId] = t_e;
//}
//
//ecs::GameObject* ecs::Manager::getHandler(handlerId_type t_hId)
//{
//    assert(t_hId < maxHandlerId);
